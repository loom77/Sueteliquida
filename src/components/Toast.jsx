...
export default function Toast({ toast, onClose }) {
  ...
  return (
    <div role="status" aria-live="polite" className="fixed bottom-20 left-4 right-4 z-50 rounded-2xl border border-default bg-primy-700 p-4 text-white shadow-xl lg:bottom-6 lg:left-auto lg:right-6 lg:w-[360px]">
