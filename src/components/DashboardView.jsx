...
export default function DashboardView({ now, history, monthlyStats, totals, dueByGame, drawOverview, onGenerate, onAddExternal, onOpenPlays, onExplore, onCheckAll, checking }) {
  ...
  return (
    <div className="primy-home mx-auto max-w-6xl px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
      ...
      <HomeOverview monthlyStats={monthlyStats} totals={totals}/>
