...
const CORE_STEPS = [
  ...
  },
  {
    ...
    text: 'Combina automatización, estadísticas informativas y lógica de validación para preparar cada columna con rapidez y coherencia.',
  },
  {
    icon: CheckIcon,
      ...
      <div id="primy-core-info-dialog">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-secondary sm:text-base">
              Primy Core es el corazón operativo de Primy: un sistema sofisticado que usa un motor inteligente de análisis avanzado para ayudarte a preparar jugadas válidas, consultar estadísticas descriptivas y comprobar premios desde un mismo lugar.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          <div className="rounded-2xl border border-primy-200 bg-primy-50/80 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-primy-900/80">
              Aplica reglas, calcula costes, ordena estadísticas descriptivas y deja cada jugada lista para revisar.
            </p>
          </div>
        ...
        <div className="mt-6 flex flex-col-reverse gap-3 border-t border-default pt-5 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs leading-5 text-secondary">
            Primy Core usa automatización y análisis como apoyo. Las estadísticas son informativas y nunca aseguran una ganancia.
          </p>
