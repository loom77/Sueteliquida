...
export default function GeneratorPanel({ game, activeGame, onGameChange, columnCount, setColumnCount, onGenerate, busy, progress = 0, generationError, monthlySpent = 0, monthlyLimit = null, variantLabel = '', onClearVariant }) {
  ...
  return (
    <section className="primy-panel primy-card-enter p-5 md:p-7">
      ...
      <div className="mt-6 grid items-stretch gap-5 lg:grid-cols-[minmax(0,1fr)_270px]">
        <div className={`overflow-hidden rounded-3xl border p-5 sm:p-6 ${isPrimitiva ? 'border-primy-200 bg-gradient-to-br from-primy-50 via-ivory to-cream dark:from-primy-950 dark:to-surface' : 'border-violet-200 bg-gradient-to-br from-lavender via-ivory to-cream dark:from-violet-950 dark:to-surface'}`}>
