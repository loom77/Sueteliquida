...
const STEPS = [
  { icon: PlusIcon, mascot: 'helper', title: 'Crea tu jugada con Primy Core', text: 'Elige el juego y el número de columnas. Primy prepara una selección válida, clara y sin columnas duplicadas dentro del mismo boleto.' },
  ...
  return (
    <AccessibleDialog open={open} onClose={finish} labelledBy="onboarding-title" className="sm:max-w-2xl" closeOnBackdrop={false}>
      <div className="flex items-start justify-between gap-4">
        <div><p className="text-sm font-bold text-primy-700">Bienvenido a Primy</p><h2 id="onboarding-title" className="mt-1 text-2xl font-semibold text-primary">Todo tu juego, en un solo lugar</h2></div>
