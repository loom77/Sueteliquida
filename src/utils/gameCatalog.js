...
export const GAME_CATALOG = {
  ...
  bonoloto: {
    ...
    shortName: 'Bonoloto',
    familyId: 'numbers',
    description: 'Juego numérico de alta frecuencia con complementario y reintegro.',
    betModel: 'Combinación numérica',
  ...
  'loteria-nacional': {
    ...
    familyId: 'national',
    description: 'Registro de décimos, números, fracciones, series y sorteos extraordinarios.',
    betModel: 'Décimo y serie',
