        ...
        runtimeCaching: [
          {
            ...
            options: { cacheName: 'primy-bootstrap-v15-6-0', networkTimeoutSeconds: 6, expiration: { maxEntries: 8, maxAgeSeconds: 1800 } },
          },
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/history'),
            handler: 'StaleWhileRevalidate',
            options: { cacheName: 'primy-history-v15-6-0', expiration: { maxEntries: 12, maxAgeSeconds: 86400 } },
          },
          {
            urlPattern: ({ url }) => url.pathname.startsWith('/api/check-results'),
            handler: 'NetworkFirst',
            options: { cacheName: 'primy-results-v15-6-0', networkTimeoutSeconds: 4, expiration: { maxEntries: 24, maxAgeSeconds: 300 } },
          },
        ],
      },
      manifest: {
