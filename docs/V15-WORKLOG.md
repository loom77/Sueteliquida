...
- Modelo multicomponente con cinco números y dos estrellas.
- Generación uniforme sin uso predictivo del histórico.
- Registro manual, visualización, archivo y comprobación completos.
- Trece categorías de premio y persistencia `secondary_numbers`.
- Sincronización SELAE/Supabase ampliada a Euromillones.
- Validación conjunta de Yuma, Alvaro, David/Euler y Nico.
